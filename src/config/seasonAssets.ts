...
export const AWARD_LOGO_KINDS: readonly {
  ...
  { id: 'ballon', label: "Ballon d'Or", pattern: /ballon\s*d'?or/i, image: ballonDorLogo },
  { id: 'golden', label: 'Golden Boot', pattern: /golden\s*boot/i, image: goldenBootLogo },
  {
    id: 'fifa',
    label: 'FIFA Best',
    pattern: /fifa\s*best|the\s*best\s*player/i,
    image: fifaBestLogo,
  },
]
